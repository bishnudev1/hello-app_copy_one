...
class CardRepoImpl implements CardRepo {
  ...
  Future<Either<ApiException, ActivateCardResponse>> addCard(
    ...
    try {
      final response = await _apiClient.post(
          "https://api.taptohello.com/user/add-card",
  ...
  Future<Either<ApiException, ConnectedUserResponse>>
    ...
    try {
      ...
      final uri = Uri.parse('https://api.taptohello.com/user/get-user-connects');
      final headers = {
      ...
      // final response = await dio.get("https://api.taptohello.com/user/get-user-connects",
      ...
      //
      // // _apiClient.get(
      // //   "https://api.taptohello.com/user/get-user-connects",
      // // );
  ...
  Future<Either<ApiException, SuccessResponse>> toggleFav(String uid) async {
    try {
      ...
      final response = await _apiClient.put(
          "https://api.taptohello.com/user/toggle-favourite/$uid", body);
  ...
  Future<Either<ApiException, SuccessResponse>> removeContact(
    ...
    try {
      final response = await _apiClient.post(
          "https://api.taptohello.com/user/remove-connect",
  ...
  Future<Either<ApiException, ConnectedUserResponse>> searchConnects(
    ...
    try {
      final response = await _apiClient.get(
        "https://api.taptohello.com/user/search-contacts?keyword=$keyword",
      );
      return Right(ConnectedUserResponse.fromJson(response.data!));
    } catch (e) {
      return Left(ApiException(e.toString()));
