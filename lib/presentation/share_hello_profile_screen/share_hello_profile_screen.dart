                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                            ...
                                            onTap: () {
                                              (_userDetailService
                                                      ...
                                                      _userDetailService
                                                          ...
                                                          null)
                                                  ? launchUrl(Uri.parse(
                                                      "https://api.whatsapp.com/send?text=Check out my profile https://taptohello.com/profile/${_userDetailService.userDetailResponse?.user?.username}"))
                                                  : launchUrl(Uri.parse(
                                                      "https://api.whatsapp.com/send?text=Check out my profile https://taptohello.com/profile/${_userDetailService.userDetailResponse?.user?.id}"));
                                            },
                                            child: Padding(
                                                padding: getPadding(
                                                    left: 9,
                                          ...
                                          InkWell(
                                            onTap: () {
                                              Share.share(
                                                  "Check out my HelloProfile https://taptohello.com/profile/${_userDetailService.userDetailResponse?.user?.id}");
                                              // launchUrl(Uri.parse(
                                              //     "https://instagram.com/"));
                                            },
                                            child: Padding(
                                          ...
                                          onTap: () {
                                            Share.share((_userDetailService
                                                    ...
                                                    _userDetailService
                                                            ...
                                                            ?.username !=
                                                        null)
                                                ? "Check out my Hello profile https://taptohello.com/profile/${_userDetailService.userDetailResponse?.user?.username}"
                                                : "Check out my Hello profile https://taptohello.com/profile/${_userDetailService.userDetailResponse?.user?.id}");
                                          },
                                          child: Padding(
                                              padding: getPadding(
                                                  left: 10,
