      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Default Variant to be displayed to the customer',
              style: TextStyle(
                fontSize: 16,
            ...
            /// The price Heading
            Text(
              'The Price (MRP, Discounted Price) that will appear against a product when buyer visits the product detail screen will be based on the below selection:',
              style: TextStyle(
                fontSize: 15,
