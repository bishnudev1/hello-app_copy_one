    ...
    controller = WebViewController()
      ...
      ..setNavigationDelegate(NavigationDelegate(
          ...
          onNavigationRequest: (NavigationRequest request) {
            if (!request.url
                .startsWith('https://hellonew.arjunglasshouse.com/${_userDetailService.userDetailResponse?.user?.id}')) {
      ...
      ..loadRequest(Uri.parse(widget.url == null
          ? "https://hellonew.arjunglasshouse.com/${_userDetailService.userDetailResponse?.user?.id}"
          : widget.url ?? ""));
