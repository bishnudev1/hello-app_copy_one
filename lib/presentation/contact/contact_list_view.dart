...
import 'package:swapnil_s_application4/presentation/contact/export_bottomSheet.dart';
import 'package:swapnil_s_application4/presentation/contact/export_contact.dart';
      ...
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => QrProfileScreenWebview(
            url:
                "https://taptohello.com/profile/${contacts.id ?? ""}?profile=yes",
          ),
        ));
        print("https://taptohello.com/profile/${contacts.id ?? ""}");
      },
      child: Card(
        margin: getMargin(
          top: 14,
