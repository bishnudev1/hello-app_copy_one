...
import 'package:swapnil_s_application4/presentation/premium/features.dart';
                                                ...
                                                if(_userDetailService
                                                  ...
                                                  if (_userDetailService
                                                    ...
                                                    if (_userDetailService
                                                        ...
                                                        false) {
                                                      _launchURL(
                                                          "https://taptohello.com/hello_pro?id=${_viewModel.getPlanResponse?.plans?[index].id}&user=${_userDetailService.userDetailResponse?.user?.id}");
                                                    }
                                                  }
                                                  if (_userDetailService
                                                      .userDetailResponse
